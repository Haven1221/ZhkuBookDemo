...
import com.haven.interfaces.StoreInterface;
import com.haven.interfaces.TempStoreInterface;
...
public class StoreTest {
	...
	private TempStoreInterface ti = null;
	private StoreInterface si = null;
	
	@Test
	public void testTempStore_insert() {
		try {
			sqlSession = MyBatisUtil.openSession();
			ti = sqlSession.getMapper(TempStoreInterface.class);
...
//			tStore.setUserName("Haven");
	...
	public void testStore_insert() {
		try {
			sqlSession = MyBatisUtil.openSession();
			ti = sqlSession.getMapper(TempStoreInterface.class);
			si = sqlSession.getMapper(StoreInterface.class);
